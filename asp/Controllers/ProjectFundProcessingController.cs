...
namespace asp.Controllers
{
    ...
    public class ProjectFundProcessingController : Controller
    {
        ...
        [HttpGet()]
        public async Task<IActionResult> GetAllProjectFunds(int page = 1, int size = 10, string filterType = ApprovedConst.PROCESSING, string? userId = "")
        {
            ...
            {
                datas = await _resp.GetAllAsync(skipAmount, size, filterType, userId);
            }
